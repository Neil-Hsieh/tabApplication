...
//        [closeButton.layer setCornerRadius:kCustomIOSAlertViewCornerRadius];
        UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:closeButton.bounds byRoundingCorners:( UIRectCornerBottomLeft | UIRectCornerBottomRight) cornerRadii:CGSizeMake(kCustomIOSAlertViewCornerRadius, kCustomIOSAlertViewCornerRadius)];
